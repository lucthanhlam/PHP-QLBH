                        ...
                        <div class="col-md-8">
                            <form action="" method="POST" enctype="multipart/form-data"s>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="8.000.000" name="price">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="1.000" name="number">
